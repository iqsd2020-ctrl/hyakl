...
import { bindDailyQuestsDeps, initDailyQuests as dq_initDailyQuests, updateQuestProgress as dq_updateQuestProgress } from './daily_quests.js?v=4.0.5';
...
const __MAIN_PARTS__ = [
  './main/part-00-core.js?v=4.0.5',
  './main/part-01-profile-and-setup.js?v=4.0.5',
  './main/part-02-quiz-engine.js?v=4.0.5',
  './main/part-03-ui-nav-leaderboard.js?v=4.0.5',
  './main/part-04-reset-admin.js?v=4.0.5',
  './main/part-05-shop-bag.js?v=4.0.5',
  './main/part-06-settings-misc.js?v=4.0.5',
  './main/part-99-init.js?v=4.0.5'
];
